                            ...
                            if (!QAMain.enableArmorIgnore) {
                                try {
                                    ...
                                    for (ItemStack is : new ItemStack[]{player.getInventory().getHelmet(),
                                        ...
                                        if (is != null) {
                                            Collection<AttributeModifier> attributes = is.getItemMeta().getAttributeModifiers(Attribute.ARMOR);
                                            Collection<AttributeModifier> toughnessAttributes = is.getItemMeta().getAttributeModifiers(Attribute.ARMOR_TOUGHNESS);
